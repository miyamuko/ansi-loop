...
ansi-loop は {Macintosh Common Lisp}[http://code.google.com/p/mcl/] の
...
参考: {LOOP: A variety of Loop macros.}[http://www.cs.cmu.edu/afs/cs/project/ai-repository/ai/lang/lisp/code/iter/loop/0.html]


=== INSTALL

1. {NetInstaller}[http://www7a.biglobe.ne.jp/~hat/xyzzy/ni.html]
   で ansi-loop をインストールします。
...
要望やバグは
{GitHub Issues}[http://github.com/miyamuko/ansi-loop/issues] か
...
MIT の loop マクロなど、{@g000001}[http://twitter.com/#!/g000001] さんにいろいろ教えてもらいました。
